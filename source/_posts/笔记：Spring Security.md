...
Spring Security 是一个专为基于 Spring 的应用程序设计的强大安全框架。它主要提供用户认证（如登录）、基于权限的访问控制（限制用户访问特定资源或方法）、“记住我”功能（实现登录状态的持久化），以及多种安全防护机制，用于抵御常见攻击。

---


### 3. Spring Security 核心图示

![](image-20250519155802069.png)
